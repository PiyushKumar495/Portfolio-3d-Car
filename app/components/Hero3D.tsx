...
export function Hero3D({ onStart }: Hero3DProps) {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black z-50 overflow-y-auto">
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="mb-8">
          <div className="text-6xl mb-4 filter drop-shadow-[0_0_20px_rgba(139,92,246,0.8)]">
            🚗
          </div>
        </motion.div>
        ...
        >
          An immersive 3D village experience showcasing my work as a
        ...
        >
          ...
          <motion.button
            onClick={onStart}
            className="group relative px-12 py-5 rounded-full font-bold text-xl overflow-hidden"
        ...
        >
          Explore the standard portfolio or jump directly into the immersive
          3D village experience
        </motion.p>
        ...
        <motion.div
          variants={fadeInUp}
          className="mt-8 flex gap-6 justify-center text-sm flex-wrap"
        >
          <a
